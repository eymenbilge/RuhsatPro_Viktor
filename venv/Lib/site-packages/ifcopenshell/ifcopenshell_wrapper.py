...
class IteratorSettings(_object):
    ...
    def set_context_ids(self, value):
        """set_context_ids(IteratorSettings self, IntVector value)"""
...
class Triangulation(Representation):
    ...
    def __init__(self, *args):
        ...
        __init__(IfcGeom::Representation::Triangulation self, ElementSettings settings, std::string const & id, DoubleVector verts, IntVector faces, IntVector edges, DoubleVector normals, DoubleVector uvs, IntVector material_ids, std::vector< std::shared_ptr< IfcGeom::SurfaceStyle >,std::allocator< std::shared_ptr< IfcGeom::SurfaceStyle > > > const & styles, IntVector item_ids) -> Triangulation
        """
...
def construct_iterator_with_include_exclude(settings, file, elems, include, num_threads):
    """construct_iterator_with_include_exclude(IteratorSettings settings, file file, StringVector elems, bool include, int num_threads) -> Iterator"""
...
def construct_iterator_with_include_exclude_globalid(settings, file, elems, include, num_threads):
    """construct_iterator_with_include_exclude_globalid(IteratorSettings settings, file file, StringVector elems, bool include, int num_threads) -> Iterator"""
...
def construct_iterator_with_include_exclude_id(settings, file, elems, include, num_threads):
    """construct_iterator_with_include_exclude_id(IteratorSettings settings, file file, IntVector elems, bool include, int num_threads) -> Iterator"""
...
class file(_object):
    ...
    def types_with_super(self):
        """types_with_super(file self) -> StringVector"""
