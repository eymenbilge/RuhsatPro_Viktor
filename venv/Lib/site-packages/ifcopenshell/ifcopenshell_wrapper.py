...
class piecewise_function_evaluator(object):
    r"""Proxy of C++ ifcopenshell::geometry::piecewise_function_evaluator class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, pwf, settings=None):
        r"""__init__(piecewise_function_evaluator self, ifcopenshell::geometry::taxonomy::piecewise_function::const_ptr pwf, Settings settings=None) -> piecewise_function_evaluator"""
        _ifcopenshell_wrapper.piecewise_function_evaluator_swiginit(self, _ifcopenshell_wrapper.new_piecewise_function_evaluator(pwf, settings))

    def evaluation_points(self, *args):
        r"""
        evaluation_points(piecewise_function_evaluator self) -> std::vector< double,std::allocator< double > >
        evaluation_points(piecewise_function_evaluator self, double ustart, double uend, unsigned int nsteps) -> std::vector< double,std::allocator< double > >
        """
        return _ifcopenshell_wrapper.piecewise_function_evaluator_evaluation_points(self, *args)

    def evaluate(self, *args):
        r"""
        evaluate(piecewise_function_evaluator self) -> ifcopenshell::geometry::taxonomy::item::ptr
        evaluate(piecewise_function_evaluator self, double ustart, double uend, unsigned int nsteps) -> ifcopenshell::geometry::taxonomy::item::ptr
        evaluate(piecewise_function_evaluator self, double u) -> Eigen::Matrix4d
        """
        return _ifcopenshell_wrapper.piecewise_function_evaluator_evaluate(self, *args)
    __swig_destroy__ = _ifcopenshell_wrapper.delete_piecewise_function_evaluator

# Register piecewise_function_evaluator in _ifcopenshell_wrapper:
_ifcopenshell_wrapper.piecewise_function_evaluator_swigregister(piecewise_function_evaluator)
